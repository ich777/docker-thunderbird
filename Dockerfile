...
RUN export TZ=Europe/Rome && \
	apt-get update && \
	apt-get -y install --no-install-recommends bzip2 libgtk-3-0 libdbus-glib-1-2 ttf-wqy-zenhei fonts-wqy-microhei fonts-takao fonts-arphic-uming fonts-noto-cjk libasound2 && \
